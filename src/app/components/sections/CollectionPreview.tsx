...
export function CollectionPreview({ onOpen }: { onOpen: (v: Vehicle) => void }) {
  ...
  return (
    <section id="colecao" className="border-t border-border py-16 sm:py-24 lg:py-32">
      <Container>
        ...
        {/* Not found block */}
        <div className="mt-16 flex flex-col items-start justify-between gap-6 rounded-2xl border border-border bg-card p-8 lg:flex-row lg:items-center lg:p-12">
